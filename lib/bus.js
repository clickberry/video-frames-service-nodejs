...
function Bus(options) {
  ...
  var video_creates_reader = new nsq.Reader('video-recognitions', 'extract-frames', {
...
Bus.prototype.publishVideoFrameCreated = function (frame, fn) {
  this._writer.publish('video-frame-creates', frame, function (err) {
    fn(err);
  });
};
